...
namespace DDona.Solid.LSP.AppConsole
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            List<BaseEmployee> employees = new List<BaseEmployee>() { intern1, employee1, manager1 };
            ...
            List<IPaidEmployee> paidEmployees = new List<IPaidEmployee>() { manager1, employee1 };
